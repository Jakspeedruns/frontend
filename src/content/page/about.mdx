...
Difficulty 2 - 100 runners needed. If less than 100 runners, max points = 10 * total runners
Difficulty 3 - 25 runners needed. If less than 100 runners, max points = 40 * total runners
Difficulty 4 - 10 runners needed. If less than 100 runners, max points = 100 * total runners
...
To Be Determined:
Category Extensions - Which categories get points? Some categories are essentially duplicates of main category runs (i.e., 100% Hub runs, All Missions Acts, NMS). How many runners are needed before they are added to the boards?
